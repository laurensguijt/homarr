      ...
      }),
      {
        fahrenheit: {
          shouldHide(_, integrationKinds) {
            ...
            return integrationKinds.every((kind) => kind === "proxmox" || kind === "unraid") || integrationKinds.length === 0;
          },
        },
        fileSystem: {
          shouldHide(_, integrationKinds) {
        ...
        showUptime: {
          shouldHide(_, integrationKinds) {
            ...
            return !integrationKinds.includes("proxmox") && !integrationKinds.includes("unraid");
          },
        },
